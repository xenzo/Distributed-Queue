...
public class TwoPhaseBmt {
    ...
    private final transient Logger logger = Logger.getLogger("com.tmax.collection");
    TwoPhaseDequeSupport<String, Tmp> core = new TwoPhaseDequeSupport<>();
    ConcurrentSkipListMap<String, Tmp> bias = new ConcurrentSkipListMap<>();
    ...
    private final static int CNT = 1000;
