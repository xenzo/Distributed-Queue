...
class LinkedDequeSupport<V> {
    ...
    /** The null node. */
    final transient Node<V> NULL_NODE = new Node<>(null);
    /** The head. */
    ...
    /** repo에 존재하는 전체 노드 갯수. */
    private final transient AtomicLong _totalCount = new AtomicLong(0);
    {
...
//            nextNode.prev();
    ...
    private abstract class Itr<T> implements Iterator<T> {
        ...
        @Override public final void remove() {
            ...
            if (l == null || l.isDeleted() || (l.isReal() && !l.delete()) || !l.deleteSolidly()) throw new IllegalStateException();
        }
    }
     ...
     * The Class AscIter.
     */
    private final class AscIter extends Itr<V> {
        /**
     ...
     * The Class DescIter.
     */
    private final class DescIter extends Itr<V> {
        /**
