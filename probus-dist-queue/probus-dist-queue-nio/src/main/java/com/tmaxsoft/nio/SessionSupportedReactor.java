...
import com.tmaxsoft.nio.api.IChannelSessionManager;
import com.tmaxsoft.nio.api.ISelector;
import com.tmaxsoft.nio.api.ISelectorConfig;
import com.tmaxsoft.nio.api.ISelectorCreator;
...
abstract public class SessionSupportedReactor extends AbstractReactor
    ...
    /** The _session map. */
    private final Map<SelectableChannel, ISession> _sessionMap = new ConcurrentSkipListMap<>();
